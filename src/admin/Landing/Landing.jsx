...
class Landing extends React.Component {
  ...
  updateCaption() {
    ...
    let caption = user ? user.name : 'Пользователь'
  ...
  render() {
    ...
    if (this.changed()) {
      buttons = (
        <div style={style.buttons}>
          ...
          <TButton style={style.save} name={'save'} onClick={this.handleClick}>
            Сохранить
          </TButton>
        </div>
      )
    ...
    return (
      <div style={style}>
        ...
        <MessageForm style={style.messageForm} user={this.props.user} />
      </div>
    )
  }
}
